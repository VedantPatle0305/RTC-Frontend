  ...
  return (
    <>
      ...
      <div className='bg-[#C3D8F0] w-[100vw] h-[100vh] flex justify-center items-center'>
        <div className='w-[90%] sm:w-[400px] pl-0 ml-0 h-[400px] sm:pl-0 sm:ml-9 mt-20 relative border border-white bg-[#f8f8f8] '>

          <div className='relative w-full mt-5'>
            <h3 className='mx-auto text-5xl font-bold tracking-wider text-black w-full text-center justify-center'>Login</h3>
          </div>
          ...
          <form className='flex flex-col items-center gap-y-6 mt-[12%]' onSubmit={formSubmit}>
            ...
            <button className='w-[100%]  sm:w-[80%] h-[50px] font-bold text-[#fff] tracking-wide text-[17px] bg-[#0D6EC8] relative' type='submit'>
